...
const CHAIN_IMAGES: { [key: number]: string } = {
  421614:
    "https://arbiscan.io/assets/arbitrum/images/svg/logos/chain-dark.svg?v=25.1.4.0",
  11155420:
    "https://sepolia-optimism.etherscan.io/assets/opsepolia/images/svg/logos/chain-dark.svg?v=25.1.4.0",
};
...
function CharacterCard({
  ...
  const characterId = Object.entries(CHARACTER_NAMES).find(
    ...
    <div className="bg-gray-700/30 rounded-lg p-3 hover:bg-gray-700/50 transition-all animate-slide-in">
      ...
      <div className="mb-2">
        <select
          value={selectedPower ?? ""}
          onChange={(e) =>
            setSelectedPower(e.target.value ? Number(e.target.value) : null)
          }
        ...
        {[421614, 11155420].map((chainSlug) => (
          ...
          >
            ...
            <p className="animate-fade-in">
              Chemical X: {localGameState.chemicalX[chainSlug]}
            </p>
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-400">Life:</span>
                <span className="text-sm text-gray-300">
                  {localGameState.life[chainSlug]}
                </span>
              </div>
              <HealthBar
                value={localGameState.life[chainSlug]}
                maxValue={100}
              />
            </div>
            <p className="animate-fade-in">
            ...
            {localGameState.gameEnded &&
              localGameState.winner === chainSlug && (
